document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        fr: {
            ...
            "hero.badge": "Data Science • Market Research • Computer Science • Genre",
            "hero.rotating.prefix": "Je suis ",
            "hero.rotating.1": "Data Scientist",
            "hero.rotating.2": "Market Researcher",
            "hero.rotating.3": "Architecte IoT",
            "hero.rotating.4": "Expert Genre & Économie",
            "hero.rotating.5": "Consultant Stratégique",
            "expertise.label": "Expertise",
            "expertise.title": "Quatre Domaines de Maîtrise",
            "expertise.lead": "De l'analyse algorithmique à la politique publique inclusive — une convergence rare de compétences au service de la décision.",
            "expertise.data.title": "Data Science & IA",
            "expertise.data.desc": "Modélisation prédictive, NLP et analyse avancée pour transformer la donnée brute en intelligence décisionnelle stratégique et à haute valeur ajoutée.",
            "expertise.market.title": "Market Research",
            "expertise.market.desc": "Maîtrise complète de la chaîne d'études de marché — de la collecte terrain à l'analyse sémantique profonde — pour éclairer la stratégie et la décision marketing.",
            "expertise.iot.title": "Computer Science & IoT",
            "expertise.iot.desc": "Conception et déploiement d'architectures Edge Computing et de réseaux de capteurs connectés. Traitement de la donnée à la source pour des systèmes critiques résilients.",
            "expertise.gender.title": "Genre & Économie Durable",
            "expertise.gender.desc": "Pionnier du BSG Numérique en Afrique francophone. En préparation d'un Master à la Chaire UNESCO en « Genre, Économie et Gestion Durable de l'Eau » — spécialité Cadrage Macroéconomique et Budgétisation Sensible au Genre.",
        ...
        en: {
            ...
            "hero.badge": "Data Science • Market Research • Computer Science • Gender",
            "hero.rotating.prefix": "I am a ",
            "hero.rotating.1": "Data Scientist",
            "hero.rotating.2": "Market Researcher",
            "hero.rotating.3": "IoT Architect",
            "hero.rotating.4": "Gender & Economy Expert",
            "hero.rotating.5": "Strategic Consultant",
            "expertise.label": "Expertise",
            "expertise.title": "Four Domains of Mastery",
            "expertise.lead": "From algorithmic analysis to inclusive public policy — a rare convergence of skills serving strategic decision-making.",
            "expertise.data.title": "Data Science & AI",
            "expertise.data.desc": "Predictive modeling, NLP and advanced analysis to transform raw data into high-value strategic decision intelligence.",
            "expertise.market.title": "Market Research",
            "expertise.market.desc": "Complete mastery of the market research chain — from field collection to deep semantic analysis — to illuminate strategy and marketing decisions.",
            "expertise.iot.title": "Computer Science & IoT",
            "expertise.iot.desc": "Design and deployment of Edge Computing architectures and connected sensor networks. Data processing at the source for resilient critical systems.",
            "expertise.gender.title": "Gender & Sustainable Economy",
            "expertise.gender.desc": "Pioneer of Digital GRB in Francophone Africa. Preparing a Master's at the UNESCO Chair in 'Gender, Economy and Sustainable Water Management' — specialization in Macroeconomic Framework and Gender Responsive Budgeting.",
    ...
    const specialtiesByLang = {
        fr: ['Data Scientist', 'Market Researcher', 'Architecte IoT', 'Expert Genre & Économie', 'Consultant Stratégique'],
        en: ['Data Scientist', 'Market Researcher', 'IoT Architect', 'Gender & Economy Expert', 'Strategic Consultant']
    };
